...
Ursa Major uses Google Cloud Platform (GCP) for data management and storage, which provides a secure and scalable infrastructure for researcher data. Researchers can store their data in the form of research workstations, high-performance computing clusters, databases, and web servers, among other services. Ursa Major also implements data backup and recovery processes to ensure that researcher data is protected in the event of system failures or data loss.
...
Access Controls: Access to Ursa Major services and data stored on the services is strictly controlled, and is granted only to authorized researchers based on their role and need.
...
* Ensuring that data stored on Ursa Major is backed up and protected.
...
* Keeping the system software and hardware up-to-date to ensure the stability and performance of the system.
...
* Developing and implementing disaster recovery and business continuity plans to ensure that Ursa Major services are available even in the event of a disaster.
* Maintaining multiple copies of data to ensure that data is protected in case of data loss or corruption.
* Ensuring that the system has adequate backup power and cooling to maintain system availability during power outages or other disruptions.
* Regularly monitoring system utilization and making changes to the system as needed to ensure that it remains efficient and scalable.
* Working with researchers to ensure that their data is properly stored and managed for the long-term.
