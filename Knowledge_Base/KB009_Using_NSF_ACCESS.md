...
**Scope:** Large-Scale HPC (CPU/GPU)
**Audience:** Researchers needing capacity beyond UCR's local HPCC
...
## 3. How to Apply
1.  **Create Account:** Go to [access-ci.org](https://access-ci.org) and sign in with your UCR credentials (via CILogon).
