...
**A:** No. Under the strict Tier 1 subsidy rules (Project Polaris), Ursa Major covers baseline compute and strategic AI (Gemini). All Secure Enclaves (NIST/CMMC), Cloud GPUs (A100, L4, T4), high-performance compute, and massive storage workloads must operate via the Tier 2 Direct Recharge model to your grant COA. If you need no-cost GPU access, please utilize the [UCR HPCC](../pages/HPCC.md).
